...
namespace NaviCommon
{
    public class CBO
    {
        ...
        /// <summary>
        /// return list de hien thi len view.cshtml return ve IEnumerable
        /// </summary>
        /// <param name="ds">dataset </param>
        /// <param name="objType">objectinfo [lưu ý khai báo trong objectinfo các trường phải giống hệt trong database ]</param>
        /// <returns></returns>
        public static List<object> Fill2ListFromDataSet(DataSet ds, Type objType)
        {
            try
            {
                ...
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    ...
                    objFillObject = CreateObjectFromDataSet(objType, dr, objProperties, arrOrdinals);
                    // add to collection
                    //obj = (Type)objFillObject;  //tam thoi rem lai 
                    objFillCollection.Add(objFillObject);
                }
